...
int main(int argc, char ** argv)
{
    ...
    vars_signal_phase.insert({"reco_proton_pT_mag", SpineVar<RTYPE,TTYPE>(&vars::nue::proton_transverse_momentum_mag, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"true_proton_pT_mag", SpineVar<TTYPE,TTYPE>(&vars::nue::proton_transverse_momentum_mag, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"reco_dpT", SpineVar<RTYPE,TTYPE>(&vars::nue::delta_pT, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"true_dpT", SpineVar<TTYPE,TTYPE>(&vars::nue::delta_pT, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"reco_dphiT", SpineVar<RTYPE,TTYPE>(&vars::nue::delta_phiT, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"true_dphiT", SpineVar<TTYPE,TTYPE>(&vars::nue::delta_phiT, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"reco_dalphaT", SpineVar<RTYPE,TTYPE>(&vars::nue::delta_alphaT, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"true_dalphaT", SpineVar<TTYPE,TTYPE>(&vars::nue::delta_alphaT, &SIGCUT, &SIGCUT)});
    ...
    vars_signal_phase.insert({"reco_NuMI_azi", SpineVar<RTYPE,TTYPE>(&vars::nue::NuMI_azimuthal_angle, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"true_NuMI_azi", SpineVar<TTYPE,TTYPE>(&vars::nue::NuMI_azimuthal_angle, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"reco_NuMI_polar", SpineVar<RTYPE,TTYPE>(&vars::nue::NuMI_polar_angle, &SIGCUT, &SIGCUT)});
    vars_signal_phase.insert({"true_NuMI_polar", SpineVar<TTYPE,TTYPE>(&vars::nue::NuMI_polar_angle, &SIGCUT, &SIGCUT)});
