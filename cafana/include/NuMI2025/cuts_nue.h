...
namespace cuts::nue
{
     ...
     */
    template<class T>
        bool all_1e1p_cut(const T & obj) { return utilities_nue::cuts::fiducial_cut<T>(obj) && utilities_nue::cuts::track_containment_cut<T>(obj) && utilities_nue::cuts::flash_cut<T>(obj) && utilities_nue::topological_1e1p_cut<T>(obj); }
     ...
     */
    template<class T>
        bool all_1eNp_cut(const T & obj) { return utilities_nue::cuts::fiducial_cut<T>(obj) && utilities_nue::cuts::track_containment_cut<T>(obj) && utilities_nue::cuts::flash_cut<T>(obj) && topological_1eNp_cut<T>(obj) ; }
     ...
     */
    template<class T>
        bool all_1eX_cut(const T & obj) { return utilities_nue::cuts::fiducial_cut<T>(obj) && utilities_nue::cuts::track_containment_cut<T>(obj) && utilities_nue::cuts::flash_cut<T>(obj) && topological_1eX_cut<T>(obj); }//quality_cuts<T>(obj)
     ...
     * defining the signal.
     */
    bool signal_1e1p(const caf::SRInteractionTruthDLPProxy & obj) { return utilities_nue::cuts::neutrino(obj) && utilities_nue::cuts::fiducial_cut(obj) && utilities_nue::cuts::track_containment_cut(obj) && topological_1e1p_cut(obj); }
     ...
     */
    bool nonsignal_1e1p(const caf::SRInteractionTruthDLPProxy & obj) { return utilities_nue::cuts::neutrino(obj) && !(utilities_nue::cuts::fiducial_cut(obj) && utilities_nue::cuts::containment_cut(obj)) && topological_1e1p_cut(obj); }
     ...
     * defining a complement to the signal.
     */
    bool nonsignal_1eNp(const caf::SRInteractionTruthDLPProxy & obj) { return utilities_nue::cuts::neutrino(obj) && !(utilities_nue::cuts::fiducial_cut(obj) && utilities_nue::cuts::track_containment_cut(obj)) && topological_1eNp_cut(obj); }
     ...
     * defining the signal.
     */
    bool signal_1eX(const caf::SRInteractionTruthDLPProxy & obj) { return utilities_nue::cuts::neutrino(obj) && utilities_nue::cuts::fiducial_cut(obj) && utilities_nue::cuts::track_containment_cut(obj) && topological_1eX_cut(obj); }
     ...
     * defining a complement to the signal.
     */
    bool nonsignal_1eX(const caf::SRInteractionTruthDLPProxy & obj) { return utilities_nue::cuts::neutrino(obj) && !(utilities_nue::cuts::fiducial_cut(obj) && utilities_nue::cuts::track_containment_cut(obj)) && topological_1eX_cut(obj); }
