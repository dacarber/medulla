...
namespace cuts::muon2024
{
     ...
     */
    template<class T>
    bool all_1muNp_cut(const T & obj) { return fiducial_cut<T>(obj) && track_containment_cut<T>(obj) && topological_1muNp_cut<T>(obj); } //&& flash_cut<T>(obj)
     ...
     */
    template<class T>
    bool signal_1muNp(const T & obj) { return neutrino(obj) && fiducial_cut(obj) && track_containment_cut(obj) && topological_1muNp_cut(obj); }
