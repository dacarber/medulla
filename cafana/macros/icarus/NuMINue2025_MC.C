...
void NuMINue2025_MC()
{
    ...
    vars_selected_nu_phase.insert({"reco_NuMI_angle", SpineVar<RTYPE,RTYPE>(&vars::nue::NuMI_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_NuMI_angle", SpineVar<TTYPE,RTYPE>(&vars::nue::NuMI_angle, &CUT, &TCUT)});
    ...
    vars_selected_cosmic_phase.insert({"reco_NuMI_angle", SpineVar<RTYPE,RTYPE>(&vars::nue::NuMI_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_NuMI_angle", SpineVar<TTYPE,RTYPE>(&vars::nue::NuMI_angle, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"reco_NuMI_angle", SpineVar<RTYPE,RTYPE>(&vars::nue::NuMI_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_NuMI_angle", SpineVar<TTYPE,RTYPE>(&vars::nue::NuMI_angle, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"reco__NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::NuMI_polar_angle, &CUT, &TCUT)});
