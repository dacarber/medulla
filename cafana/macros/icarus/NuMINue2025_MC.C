...
void NuMINue2025_MC()
{
    ...
    ana::SpectrumLoader mc("/pnfs/icarus/persistent/users/dcarber/spine/NuMI_CV_flat_cafs/*.flat.root");
    ...
    vars_selected_nu_phase.insert({"true_electron_conv_dist", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_vertex_distance, &CUT, &TCUT)});
    ...
    vars_selected_nu_phase.insert({"true_electron_axial_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_axial_spread, &CUT, &TCUT)});
    ...
    vars_selected_nu_phase.insert({"true_electron_dir_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_directional_spread, &CUT, &TCUT)});
    ...
    vars_selected_nu_phase.insert({"true_electron_dedx", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_dedx, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"reco_electron_NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_electron_NuMI_polar", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"reco_electron_NuMI_azi", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_azimuthal_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_electron_NuMI_azi", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_azimuthal_angle, &CUT, &TCUT)});
    ...
    vars_selected_nu_phase.insert({"reco_proton_conv_dist", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_vertex_distance, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_proton_conv_dist", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_vertex_distance, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"reco_proton_axial_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_axial_spread, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_proton_axial_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_axial_spread, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"reco_proton_dir_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_directional_spread, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_proton_dir_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_directional_spread, &CUT, &TCUT)});
    ...
    vars_selected_nu_phase.insert({"reco_proton_dedx", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_dedx, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_proton_dedx", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_dedx, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"reco_proton_NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_proton_NuMI_polar", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"reco_proton_NuMI_azi", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_azimuthal_angle, &CUT, &TCUT)});
    vars_selected_nu_phase.insert({"true_proton_NuMI_azi", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_azimuthal_angle, &CUT, &TCUT)});
    ...
    analysis.AddTree("SelectedNu_Cuts", vars_selected_nu, false);
    ...
    vars_selected_cosmic_phase.insert({"true_electron_conv_dist", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_vertex_distance, &CUT, &TCUT)});
    ...
    vars_selected_cosmic_phase.insert({"true_electron_axial_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_axial_spread, &CUT, &TCUT)});
    ...
    vars_selected_cosmic_phase.insert({"true_electron_dir_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_directional_spread, &CUT, &TCUT)});
    ...
    vars_selected_cosmic_phase.insert({"true_electron_dedx", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_dedx, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"reco_electron_NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_electron_NuMI_polar", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"reco_electron_NuMI_azi", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_azimuthal_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_electron_NuMI_azi", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_azimuthal_angle, &CUT, &TCUT)});
    ...
    vars_selected_cosmic_phase.insert({"reco_proton_conv_dist", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_vertex_distance, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_proton_conv_dist", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_vertex_distance, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"reco_proton_axial_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_axial_spread, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_proton_axial_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_axial_spread, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"reco_proton_dir_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_directional_spread, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_proton_dir_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_directional_spread, &CUT, &TCUT)});
    ...
    vars_selected_cosmic_phase.insert({"reco_proton_dedx", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_dedx, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_proton_dedx", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_dedx, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"reco_proton_NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_proton_NuMI_polar", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_polar_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"reco_proton_NuMI_azi", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_azimuthal_angle, &CUT, &TCUT)});
    vars_selected_cosmic_phase.insert({"true_proton_NuMI_azi", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_azimuthal_angle, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"true_electron_conv_dist", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_vertex_distance, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_electron_axial_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_axial_spread, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_electron_axial_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_axial_spread, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"true_electron_dir_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_directional_spread, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"true_electron_dedx", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_dedx, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_electron_NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_polar_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_electron_NuMI_polar", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_polar_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_electron_NuMI_azi", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_azimuthal_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_electron_NuMI_azi", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_electron_NuMI_azimuthal_angle, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"reco_proton_conv_dist", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_vertex_distance, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_proton_conv_dist", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_vertex_distance, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_proton_axial_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_axial_spread, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_proton_axial_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_axial_spread, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_proton_dir_spread", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_directional_spread, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_proton_dir_spread", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_directional_spread, &CUT, &TCUT)});
    ...
    vars_purity_phase.insert({"reco_proton_dedx", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_dedx, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_proton_dedx", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_dedx, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_proton_NuMI_polar", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_polar_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_proton_NuMI_polar", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_polar_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"reco_proton_NuMI_azi", SpineVar<RTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_azimuthal_angle, &CUT, &TCUT)});
    vars_purity_phase.insert({"true_proton_NuMI_azi", SpineVar<TTYPE,RTYPE>(&vars::nue::leading_proton_NuMI_azimuthal_angle, &CUT, &TCUT)});
