...
int main()
{
    ...
    ana::Analysis analysis("NuMI_offbeam_data");

    ana::SpectrumLoader offbeam("/pnfs/icarus/persistent/users/dcarber/spine/combined_files/NuMI_offbeam_data_flat_cafs/*.root");
    ...
    vars_selected_nu_phase.insert({"nu_E", SpineVar<TTYPE,RTYPE>(&vars::neutrino_E, &cuts::no_cut, &TCUT)});
